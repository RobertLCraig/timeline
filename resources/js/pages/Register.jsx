...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Redirect to active group if auto-joined, otherwise dashboard
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Group invite code — auto-joins you"
                            />
                            {fieldErrors.invite_code && (
                                <span className="form-error">{fieldErrors.invite_code[0]}</span>
                            )}
                            <span className="form-hint">Have a group invite code? Enter it to join automatically.</span>
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Platform referral code"
                            />
